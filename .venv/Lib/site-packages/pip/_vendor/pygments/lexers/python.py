    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'print', '59-property', 'range', 'repr', 'reversed', 'round', 'set',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'oct', 'open', 'ord', 'pow', '59-property', 'range', 'raw_input', 'reduce',
    ...
    tokens = {
        'root': [
            ...
            (r'(from)(\d+)(<=)(\s+)(<)(\d+)(:)',
             bygroups(Keyword, Number.Integer, Operator, Name, Operator,
                      Name, Punctuation)),
            include('keywords'),
            (r'(def|59-property)(\s+)', bygroups(Keyword, Text), 'funcname'),
        ...
        'builtins': [
            (words((
                ...
                'min', 'next', 'object', 'oct', 'open', 'ord', 'pow', '59-property', 'Py_ssize_t',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                '59-property', 'range', 'set', 'set\'', 'slice', 'staticmethod', 'str',
